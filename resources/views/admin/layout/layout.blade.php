            ...
            <div class="col-md-3 left_col">
               <div class="left_col scroll-view">
                  <div class="navbar nav_title" style="border: 0;">
                     <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>{{@config('site_name.site_name')}}</span></a>
                  </div>
                  ...
                  <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                     <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                           <li><a href="{{url('/admin/post/list')}}"><i class="fa fa-edit"></i> Post </a></li>
						   <li><a  href="{{url('/admin/page/list')}}"><i class="fa fa-building"></i> Page </a></li>
						   <li><a  href="{{url('/admin/contact/list')}}"><i class="fa fa-comments"></i> Contact Us </a></li>
